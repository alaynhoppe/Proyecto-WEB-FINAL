    ...
    <div>
      <div className="page-header">
        <h1 className="page-title">
          {user.role === "estudiante" ? "Mis Proyectos Académicos" : "Mis Proyectos de Investigación"}
        </h1>
          ...
          <div key={proyecto.id} className="publication-card">
            ...
            <div className="publication-content">
              ...
              {proyecto.archivoNombre && (
                <p>
                  <strong>Archivo:</strong> <span className="badge badge-info">{proyecto.archivoNombre}</span>
                </p>
              )}
            </div>
              ...
              <form onSubmit={handleSubmit}>
                <div className="form-grid">
                  ...
                  <div className="form-group form-full">
                    ...
                    <small style={{ color: "#666", fontSize: "12px" }}>PDF, DOC, DOCX. Máximo 20MB</small>
